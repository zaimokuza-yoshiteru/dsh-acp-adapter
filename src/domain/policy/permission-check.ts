...
export interface AcpPermissionCheck {
  readonly reason: 'auto-approved' | 'bridge-unavailable' | 'inactive-connection' | 'inactive-prompt' | 'identity-unmatched' | 'invalid-tool-name' | 'not-coordination' | 'allow-once-unavailable'
