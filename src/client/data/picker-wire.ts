 ...
 * DSH Alpha Generated Remote result envelope and the sessions/settings wire
 * shapes, narrowed structurally — this layer never value-imports the client
 * runtime or a concrete Remote package.
...
/** DSH Generated Remote 结果信封（与 controller.ts SettingsMutateLike 同款）。 */
...
/** The normalized sessions wire face the picker reads/writes. */
export interface SessionsWireLike {
  ...
  /**
   * 公开 `session.create` Remote（Alpha 的 Session Controller）：
