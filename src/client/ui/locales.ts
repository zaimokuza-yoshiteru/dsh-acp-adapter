...
const zh = {
  ...
  teamModePending: '下次运行生效：{mode}',
  teamModeHint: '空闲成员立即应用；休眠成员下次运行生效。运行中或等待审批时不可调整。',
...
const en: Record<AcpLocaleKey, string> = {
  ...
  teamModePending: 'Applies on next run: {mode}',
  teamModeHint: 'Idle members apply changes immediately; dormant members apply them on their next run. Unavailable while running or awaiting approval.',
