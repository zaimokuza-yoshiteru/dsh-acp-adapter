...
const zh = {
  ...
  fieldHostToolsHint: '每行一个已安装的 DSH 工具名，留空不增加工具。Agent 通过 MCP 调用；避免选入与 Agent 自带能力重复的工具。修改工具名单后请新建会话。',
...
const en: Record<AcpLocaleKey, string> = {
  ...
  fieldHostToolsHint: 'One installed DSH tool name per line; leave empty for no additional tools. The Agent calls them over MCP. Avoid duplicating its built-in tools. Start a new session after changing this list.',
