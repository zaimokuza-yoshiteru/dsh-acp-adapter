...
const zh = {
  ...
  advancedOptionsHint: '可选。仅在需要额外配置或调用 DSH 工具时填写。',
  advancedOptionsConfigured: '已配置 {envCount} 个环境变量、{toolCount} 个 DSH 工具。',
  savedNotice: '已保存。',
  deletedNotice: '已删除。',
  fieldId: 'ID',
  ...
  fieldHostTools: 'DSH 插件工具',
  fieldHostToolsHint: '每行一个已安装的 DSH 工具名，留空不增加工具。选中的工具通过 MCP 提供给 Agent，仍遵循 Agent 审批和工具自身的执行规则。避免与 Agent 自带工具重复；修改后请新建会话。',
  errorHostTools: '工具名不可重复，仅支持字母、数字、下划线、点和短横线。',
  fieldEnv: '环境变量',
...
const en: Record<AcpLocaleKey, string> = {
  ...
  advancedOptionsHint: 'Optional. Use these only for additional configuration or access to DSH tools.',
  advancedOptionsConfigured: '{envCount} environment variables and {toolCount} DSH tools configured.',
  savedNotice: 'Saved.',
  ...
  fieldHostTools: 'DSH plugin tools',
  fieldHostToolsHint: 'One installed DSH tool name per line; leave empty for no additional tools. Selected tools are exposed over MCP and retain Agent approval and their own execution rules. Avoid duplicating built-in tools; start a new session after changes.',
  errorHostTools: 'Use unique tool names containing only letters, numbers, underscores, dots and hyphens.',
