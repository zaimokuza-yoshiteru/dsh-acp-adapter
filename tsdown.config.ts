 ...
 *
 * Alignment with the 0.1.2-alpha.5 preset:
...
export default defineConfig({
  ...
  plugins: [{
    ...
    resolveId(source) {
      ...
      throw new Error(
        `client bundle purity: "${source}" is not in the 0.1.2-alpha.5 baseline externals or this package's dsh.client.external, `
